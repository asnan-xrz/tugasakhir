...
def ingest_data(csv_path: str, db_path: str, collection_name: str, batch_size: int = 100):
    print("=== Storyboard AI Source Grounding Ingestion (allaboutITS) ===")
    ...
    # JANGAN MENGHAPUS KOLEKSI LAMA AGAR BISA MENGGABUNGKAN DATA
    # try:
    ...
    print(f"Mendapatkan koleksi '{collection_name}'...")
    ...
    with tqdm(total=total_rows, desc="Ingesting data") as pbar:
        for i in range(num_batches):
            ...
            # Gunakan prefix berbeda agar tidak menimpa id dari caption.csv
            ids = [f"allaboutits_id_{idx}" for idx in range(start_idx, end_idx)]
